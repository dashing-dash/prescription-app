...
const ViewPrescription = () => {
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      const pdfUrl = `${API}/prescriptions/${id}/pdf?inline=true&token=${token}`;
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-4 bg-blue-50 p-4 rounded-lg border border-blue-100">
              ...
              {prescription.investigations && (
                <div className="col-span-2">
                  <p className="text-sm text-gray-600 mb-1">Investigations Advised</p>
                  <p className="text-base font-semibold text-gray-900" data-testid="view-investigations">{prescription.investigations}</p>
                </div>
              )}
            </div>
          </div>
